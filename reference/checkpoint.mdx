...
| Implementation | Module | When active |
|----------------|--------|-------------|
| `MongoCheckpointStore` | `flowwarden-stream-starter` | Imperative Spring Data MongoDB on classpath |
| `ReactiveMongoCheckpointStore` | `flowwarden-stream-starter` | Reactive Spring Data MongoDB on classpath |
